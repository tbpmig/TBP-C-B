...
\section{Tutoring}\label{ugrad:tutoring} Each electee must complete at least one hour of university tutoring. %\added{The tutoring requirement may be satisfied either by flyering for tutoring or by serving as a tutor.}
...
\section{Service} Each electee must complete at least 11.5 additional hours in the Winter through at least two different service projects offered by the chapter. Any service completed in the events listed in \ref{ugrad:tutoring}--\ref{ugrad:MindSET} above the minimum may be used to satisfy this requirement.  Service performed for the completion of requirements of another society will not be accepted. Extra service hours can be used to make up missed meetings. % was ten for fall prior to F20 (COVID) and twelve for winter prior to W21 (COVID)  # Was 10 and 12 prior to F22; adjusted such that the totals are 16 and ... % Was 11.5 and 9.5 going into F23
...
\begin{enumsubsection}
	\item{Professional Development Committee} The Professional Development Committee is chaired by the Professional Development Officer, and includes the External Vice Presidents and any other chapter members as determined by the Professional Development Officer. The committee is responsible for hosting Engineering Futures sessions, information sessions with companies, and other professional development events.
...
\item{Apparel Chair} The Apparel Chair(s) will be responsible for the design and acquisition of any MI-G branded apparel that the chapter may desire. The chair(s) will serve on the Chapter Team and report to the Membership Officer. % Amended W26
...
\item{NEST Project Manager Chair} The NEST Project Manager Chair will work with the Service Coordinator to manage all operations regarding the NEST program. The NEST Project Manager will interface with National's representatives, the Officer Corps, and NEST Leadership Team to plan all operations related to the NEST Program. This chair serves on the Events Team and will report to the Service Coordinator. This chair position will expire at the end of the Fall 2026 semester. % Added W26

\item{NEST Project Engineer Chair} The NEST Project Engineer Chair will work with the Service Coordinator, NEST Project Manager Chair, and NEST Account Manager Chair to develop all deliverables for the NEST Competition along with developing content for outreach to chapter members, underclassmen, and K-12 students. This chair serves on the Events Team and will report to the Service Coordinator. This chair position will expire at the end of the Fall 2026 semester. % Added W26

\item{NEST Account Manager Chair} The NEST Account Manager Chair will work with the Service Coordinator, Treasurer, Professional Development Officer, NEST Project Manager Chair, and NEST Project Engineer Chair to distribute budget allocated to the NEST program by the Officer Corps along with managing NEST Corporate Outreach Efforts. This chair serves on the Events Team and will report to the Service Coordinator. This chair position will expire at the end of the Fall 2026 semester. % Added W26
