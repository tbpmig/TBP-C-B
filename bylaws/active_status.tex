...
\section{Tracking Status}  Active status is evaluated by the Membership Officer.  If an inactive member satisfies the above requirement mid-semester, they must also be made active immediately upon request.  
