...
\section{Chair Appointment} The procedure for appointing Chair Positions is:
\begin{enumsubsection}
\itemnotoc An application will be made available whenever is deemed most appropriate by the officer corps.
\begin{enumsubsubsection}
\itemnotoc The content of the application will be decided upon by the Reporting Officer(s) and, where applicable, the current holder(s) of the office in question.
\itemnotoc The application may close whenever is deemed most appropriate by the officer corps, provided that it has remained open for a minimum of one week from the date it was provided to membership.
\end{enumsubsubsection}
\itemnotoc The Reporting Officer(s) of a Chair shall review applications and select the best candidate(s) by means of a majority vote.
\itemnotoc The Reporting Officer(s) will notify the Officer Corps of the appointment(s) of Chairs within one week. Additionally, the Reporting Officer(s) must notify non-selected applicants within one week, including the rationale of their decision.
\itemnotoc The Officer Corps may, if requested by a non-selected applicant or on its own initiative, review a non-selection, and reverse it by a majority vote.
\end{enumsubsection} % Revised chair appointments process added, in full, in W25

\section{Project Leaders}
\label{sec:ProjectLeaderes}
Project Leaders are in charge of the planning and execution of specific projects or events, including development of new events. Project Leaders will be members of the Events Team, even though their work may be overseen by or fall within the purview of Officer(s) beyond the Events Team. %Added W25
